...
- 7 of the 8 hook characters came through separated as intended. そ did NOT — KanjiVG only carries the one-stroke form, and ships no variant, so そ currently teaches the print shape its own hookNote warns about. Needs a hand recording to override.
