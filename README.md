...
**[Play](https://thesisbytes.github.io/hito/dist/hiragana-game-v0.1.19.html)** — the game: draw below, farang advance above.  
**[Workshop](https://thesisbytes.github.io/hito/dist/hiragana-v0.1.19.html)** — the full gojūon chart and every control, which is what this project uses on itself.
