...
| *(the dashboard)* | | Hearts, 墨, 魂 and the wave on the seam, with tabs 技 (this run's skills, bought with ink) and 灯 (the lanterns, bought with 魂). A tab does not pause the run. Not configurable yet. |
